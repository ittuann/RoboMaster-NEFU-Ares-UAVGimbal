...
//	PID_Mortor_Angle[AnglePID_GimbalYaw].EX_Val = RC_CH_FIR[YAW_CHANNEL].FilterData + PID_Mortor_Angle[AnglePID_GimbalYaw].Now_Val;
	...
	// 限幅
	USER_LIMIT_MINMAX(PID_Mortor_Angle[AnglePID_GimbalPitch].EX_Val, GimbalMachine_Pitch.Min_Angle, GimbalMachine_Pitch.Max_Angle);
	USER_LIMIT_MINMAX(PID_Mortor_Angle[AnglePID_GimbalYaw].EX_Val, GimbalMachine_Yaw.Min_Angle, GimbalMachine_Yaw.Max_Angle);
	USER_LIMIT_MINMAX(PID_Mortor_Angle[AnglePID_GimbalPitch_Relative].EX_Val, GimbalMachine_Pitch.Min_Angle, GimbalMachine_Pitch.Max_Angle);
}
