...
#include <math.h>
#include "arm_math.h"	// 调用STM32自带的DSP库
...
volatile float INS_quat[4] = {1.0f, 0.0f, 0.0f, 0.0f};						// quaternion of sensor frame relative to auxiliary frame
...
//    *roll = atan2f(2.0f*(q[0]*q[1]+q[2]*q[3]),2.0f*(q[0]*q[0]+q[3]*q[3])-1.0f);
	*yaw = (atan2f(2.0f*(q[0]*q[3]+q[1]*q[2]), 2.0f*(q[0]*q[0]+q[1]*q[1])-1.0f))*180.0f/ONE_PI;
    *pitch = (asinf(-2.0f*(q[1]*q[3]-q[0]*q[2])))*180.0f/ONE_PI;
    *roll = (atan2f(2.0f*(q[0]*q[1]+q[2]*q[3]),2.0f*(q[0]*q[0]+q[3]*q[3])-1.0f))*180.0f/ONE_PI;
}
